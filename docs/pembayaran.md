...
1. Tekan Enter. Jika berhasil, akan muncul tulisan `Authtoken saved to configuration file`. Setup Ngrok selesai!
...
1. Tunggu hingga layar Ngrok muncul, lalu copy URL HTTPS yang ada di bagian **Forwarding** (Contoh: `https://a1b2-c3d4.ngrok-free.app`)

   > **⚠️ PENTING:** Jangan tutup terminal Ngrok ini selama proses testing berlangsung!

2. Buka Midtrans Sandbox Dashboard

3. Buka menu **Settings** > **Configuration** (Pengaturan > Pengaturan Umum)

4. Cari kolom **Payment Notification URL**

5. Masukkan URL Ngrok Anda ditambah dengan endpoint webhook Backend:
...
1. Scroll ke bawah dan klik tombol **Update** / **Simpan**
